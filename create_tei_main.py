...
if __name__ == '__main__':
    ...
    parser.add_argument('--txt_folder', default=f'{base_dir}/raw',
                        help='TXT files location, only set if creating TEI from TXT')
    parser.add_argument('--svala_folder', default=f'{base_dir}/svala',
                        help='Path to directory that contains svala files.')
    parser.add_argument('--results_folder', default=f'{base_dir}/results',
                        help='Path to results directory.')
    parser.add_argument('--raw_text', default=f'{base_dir}/raw',
                        help='Path to directory that contains raw text files.')
    parser.add_argument('--metadata_excel', default=f'{base_dir}/KOST.xlsm',
